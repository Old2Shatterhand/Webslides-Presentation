						...
						},
						{
							...
							value: function transitionToSlide_(isMovingForward, nextSlide, callback) {
								...
								if (this.initialised && this.plugins.touch && this.plugins.touch.isEnabled) {
									__WEBPACK_IMPORTED_MODULE_2__utils_dom__["a" /* default */].once(
										nextSlide.el,
										__WEBPACK_IMPORTED_MODULE_2__utils_dom__["a" /* default */].getAnimationEvent(),
										function () {
			...
			var Touch = (function () {
				...
				function Touch(wsInstance) {
					...
					if (__WEBPACK_IMPORTED_MODULE_0__utils_mobile_detector__["a" /* default */].isAny()) {
						...
						if (
							window.PointerEvent &&
							(__WEBPACK_IMPORTED_MODULE_0__utils_mobile_detector__["a" /* default */].isWindows() ||
								__WEBPACK_IMPORTED_MODULE_0__utils_mobile_detector__["a" /* default */].isWindowsPhone())
						) {
				...
				_createClass(Zoom, [
					{
						...
						value: function onKeyDown(event) {
							if (
								!this.isZoomed_ &&
								__WEBPACK_IMPORTED_MODULE_1__utils_keys__["a" /* default */].MINUS.some(function (key) {
								...
								this.isZoomed_ &&
								(__WEBPACK_IMPORTED_MODULE_1__utils_keys__["a" /* default */].PLUS.some(function (key) {
									return key === event.which;
								}) ||
					...
					},
					{
						...
						value: function zoomIn() {
							...
							setTimeout(function () {
								...
								Object(__WEBPACK_IMPORTED_MODULE_2__utils_scroll_to__["a" /* default */])(
									actualCurrent.parentNode.offsetTop + __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a" /* default */].parseSize(wrapCSS.paddingTop),
									50,
									function () {},
									scrollingElement
								);
